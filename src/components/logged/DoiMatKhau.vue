<template>
    <Master>
        <div class="mx-auto flex max-w-[1140px] flex-col gap-4 rounded-lg bg-white py-8 px-6">
            <h2 class="border-b border-white-f8 pb-4 text-[28px] text-[#006baa]">Đổi mật khẩu</h2>
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                <div class="col-span-1">
                    <ul class="overflow-hidden rounded-md border">
                        ...
                        <li><a class="flex cursor-pointer items-center justify-between gap-3 border px-4 py-2.5 text-sm hover:bg-gray-50"
                                href="/nap-xu"><span class="text-brown-ad"><svg stroke="currentColor"
                                        fill="currentColor" stroke-width="0" viewBox="0 0 288 512" height="1em"
                                        width="1em" xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <li><a aria-current="page"
                                ...
                                href="/doi-mat-khau"><span class=""><svg stroke="currentColor" fill="currentColor"
                ...
                <div class="col-span-1 md:col-span-2">
                    <div class="rounded-md">
                        <h3 class="rounded-t-md border border-[#ddd] bg-[#f5f5f5] px-4 py-2.5 text-sm">Đổi mật khẩu</h3>
                        <div class="space-y-4 rounded-b-md border border-t-0 border-[#ddd] p-4">
                            <form class="flex flex-col gap-4"><input
                                    ...
                                    name="oldPassword" type="password" placeholder="Mật khẩu cũ" value=""><input
                                    class="input-shadow rounded border border-solid border-gray-400 py-1 px-2 text-[15px] text-[#333333] outline-none focus:border-[#66afe9]  disabled:cursor-not-allowed disabled:bg-gray-100 w-full"
                                    name="newPassword" type="password" placeholder="Mật khẩu mới" value=""><input
                                    class="input-shadow rounded border border-solid border-gray-400 py-1 px-2 text-[15px] text-[#333333] outline-none focus:border-[#66afe9]  disabled:cursor-not-allowed disabled:bg-gray-100 w-full"
                                    name="retypeNewPassword" type="password" placeholder="Nhập lại mật khẩu mới"
                                    value="">
                                <div><button
                                        ...
                                        type="submit"><span class="flex-1 truncate">Đổi mật khẩu</span></button></div>
                            </form>
                        </div>
                    </div>
                </div>
