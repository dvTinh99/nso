<template>
    <Master>
        <div class="mx-auto flex max-w-[1140px] flex-col gap-4 rounded-lg bg-white py-8 px-6">
            <h2 class="border-b border-white-f8 pb-4 text-[28px] text-[#006baa]">Thông tin cá nhân</h2>
                ...
                <div class="col-span-1">
                    <ul class="overflow-hidden rounded-md border">
                        <li><a aria-current="page"
                                ...
                                href="/thong-tin-ca-nhan"><span class=""><svg stroke="currentColor" fill="currentColor"
...
export default {
    ...
    mounted() {
        console.log('Thong tin ca nhan ne', this.$route.fullPath);
    },
