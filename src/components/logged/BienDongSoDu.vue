                ...
                <div class="col-span-1">
                    <ul class="overflow-hidden rounded-md border">
                        ...
                        <li><a aria-current="page"
                                ...
                                href="/bien-dong-so-du"><span class=""><svg stroke="currentColor" fill="currentColor"
                        ...
                        <table class="w-full border-collapse text-[13px]">
                            <thead>
                                <tr class="bg-[#f3f3f3] text-[#444]">
                                    <th class="border border-r border-gray-200 p-2 text-left">Máy chủ</th>
                                    <th class="border border-r border-gray-200 p-2 text-left">Trước</th>
                                    <th class="border border-r border-gray-200 p-2 text-left">Sau</th>
                                    <th class="border border-r border-gray-200 p-2 text-left">Biến động</th>
                                    <th class="border border-r border-gray-200 p-2 text-left">Nội dung</th>
                                    <th class="border border-r border-gray-200 p-2 text-left">Thời gian</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
...
export default {
    ...
    mounted() {
        console.log('Bien dong so du ne', this.$route.fullPath);
    },
