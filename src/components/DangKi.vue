    ...
    <div class="mx-auto flex max-w-screen-md flex-col justify-center space-y-4 rounded-lg bg-white py-8 px-10">
        ...
        <div class="w-full text-center">
            <input v-model="username"
                ...
                name="username" type="text" placeholder="Tên tài khoản" value="" />
        </div>
        <div class="w-full text-center">
            <input v-model="nickname"
                class="input-shadow rounded border border-solid border-gray-400 py-1 px-2 text-[15px] text-[#333333] outline-none focus:border-[#66afe9] disabled:cursor-not-allowed disabled:bg-gray-100 w-full"
                name="full_name" type="text" placeholder="Tên hiển thị" value="" />
        </div>
        <div class="relative w-full text-center">
            <input v-model="secretCode"
                class="input-shadow rounded border border-solid border-gray-400 py-1 px-2 text-[15px] text-[#333333] outline-none focus:border-[#66afe9] disabled:cursor-not-allowed disabled:bg-gray-100 w-full"
                name="secretCode" type="number" placeholder="Mã bí mật" min="1" max="999999" value="" />
            <div class="has-tooltip absolute top-0 right-2 translate-y-1/2 cursor-pointer">
                <span
                    ...
                    số bí mật được dùng để cấp lại thông tin tài khoản web. Lưu ý:
                    tự bảo quản mã số bí mật tránh để lộ thông tin. Mã số bí mật phải từ
                    6 đến 12 ký tự số</span><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                    viewBox="0 0 16 16" class="text-[#777777]" height="1em" width="1em"
        ...
        <div class="w-full text-center">
            <input v-model="password"
                class="input-shadow rounded border border-solid border-gray-400 py-1 px-2 text-[15px] text-[#333333] outline-none focus:border-[#66afe9] disabled:cursor-not-allowed disabled:bg-gray-100 w-full"
                name="password" type="password" placeholder="Mật khẩu" value="" />
        </div>
        <div class="w-full text-center">
            <input v-model="rePassword"
                class="input-shadow rounded border border-solid border-gray-400 py-1 px-2 text-[15px] text-[#333333] outline-none focus:border-[#66afe9] disabled:cursor-not-allowed disabled:bg-gray-100 w-full"
                name="retypePassword" type="password" placeholder="Xác nhận mật khẩu" value="" />
        </div>
